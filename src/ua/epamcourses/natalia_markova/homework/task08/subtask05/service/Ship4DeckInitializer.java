 ...
 */
public class Ship4DeckInitializer extends ShipInitializer {
    public Ship4DeckInitializer() {
        qtyOfVariants = 19;
    }
    ...
    public Ship getShip(Cell initialCell, int variant) {
        ...
        if (variant == 1) {
            ...
            cells[2] = new Cell(initialCell.getX(), initialCell.getY());
            cells[3] = new Cell(initialCell.getX(), initialCell.getY());
        } else if (variant == 13) {
